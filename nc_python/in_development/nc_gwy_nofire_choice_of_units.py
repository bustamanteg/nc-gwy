...
# Ifs for dissipation units
    ...
    if ex_units=='eV':
        ...
        obj['/4/data/title'] = 'Dissipation ->'
        obj['/4/data'] = GwyDataField(Diss_r, xreal=xrange, yreal=yrange, xoff=xoff, yoff=yoff, si_unit_xy='m',si_unit_z='eV')
        obj['/5/data/title'] = 'Dissipation <-'
        obj['/5/data'] = GwyDataField(Diss_l, xreal=xrange, yreal=yrange, xoff=xoff, yoff=yoff, si_unit_xy='m',si_unit_z='eV')
    # ----------------------------------------
...
direct='/data/20230228_run18/'
prefix='run_18_LiNi_240'
cantsens=0.051
signalgain=1
Q=25201
f0=151708
