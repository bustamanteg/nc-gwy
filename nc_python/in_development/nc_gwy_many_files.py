...
def run(direct,prefix, cantsens, signalgain, Q, f0):
    '''
    ...
    A1w_r=datapull(fileprefix+'-Xp-ADC5.nc',1/10000) # one omega amplitude
    A1w_l=datapull(fileprefix+'-Xm-ADC5.nc',1/10000)

    A2w_r=datapull(fileprefix+'-Xp-ADC6.nc',1/100000) # two omega amplitude
    A2w_l=datapull(fileprefix+'-Xm-ADC6.nc',1/100000)
    ...
    obj.tofile(direct+'scans/'+prefix+'.gwy')

direct='/data/20221024_run17/'
prefix='killburn_r17_LiNi_1um_light_electrodes156'
cantsens=0.07
signalgain=5
Q=25000
f0=172941

prefixes=['killburn_r17_LiNi_zoom_efm_slow151',\
    ]

for prefix in prefixes:
    print('processing file:',prefix)
    run(direct,prefix, cantsens, signalgain, Q, f0)
